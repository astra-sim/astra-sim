...
WORKLOAD="${EXAMPLE_DIR:?}/../runs/Mixtral-8x22B/mixtral-8x22_chakra"
SYSTEM="${EXAMPLE_DIR:?}/../inputs/system/analytical/hgx_h100_32gpu.json"
NETWORK="${EXAMPLE_DIR:?}/../inputs/network/hgx_h100_32gpu.yml"
