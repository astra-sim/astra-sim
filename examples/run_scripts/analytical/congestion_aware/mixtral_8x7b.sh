...
WORKLOAD="${EXAMPLE_DIR:?}/../runs/Mixtral-8x7B/chakra_trace"
SYSTEM="${EXAMPLE_DIR:?}/../inputs/system/analytical/hgx_h100_8gpu.json"
NETWORK="${EXAMPLE_DIR:?}/../inputs/network/hgx_h100_8gpu.yml"
