...
PYTHONPATH=$(pwd)/chakra python3 -m et_converter.et_converter\
 --input_type Text\
 --input_filename ../../inputs/workload/ASTRA-sim-1.0/${WORKLOAD}.txt\
 --output_filename ../../inputs/workload/ASTRA-sim-2.0/${WORKLOAD}\
 --num_npus 64\
 --num_dims 1\
 --num_passes 1
