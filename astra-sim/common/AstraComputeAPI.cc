...
ComputeKernel ComputeKernel::create_llm_rmsnorm(int batch,
                                                int seq_len,
                                                int n_embed,
...
ComputeKernel ComputeKernel::create_llm_residual_addition(
    int batch, int seq_len, int n_embed, ComputeKernelPhase phase) {
    std::unordered_map<std::string, std::string> attr = {
        {"batch", std::to_string(batch)},
        {"seq_len", std::to_string(seq_len)},
        {"n_embed", std::to_string(n_embed)}};
...
ComputeKernel ComputeKernel::create_llama_attn(int batch,
                                               int seq_len,
                                               int max_seq_len,
                                               int n_embed,
                                               int num_heads,
...
ComputeKernel ComputeKernel::create_llama_mlp(int batch,
                                              int seq_len,
                                              int n_embed,
                                              int num_heads,
                                              int tensor_parallelism,
