...
class LogGP : public Callable {
  public:
    LogGP(std::string name, Sys* sys, Tick L, Tick o, Tick g, double G, EventType trigger_event);
    ~LogGP();
    ...
    void attach_mem_bus(Sys* sys, Tick L, Tick o, Tick g, double G, bool model_shared_bus, int communication_delay);
